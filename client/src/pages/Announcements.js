...
import { FaBullhorn, FaCalendar, FaPaperclip } from "react-icons/fa";
              ...
              >
                <div className="announcement-header">
                  ...
                  <div className="announcement-meta">
                    <span
                      className={`announcement-badge ${getBadgeClass(announcement.type)}`}
                    >
                ...
                {announcement.attachments &&
                  announcement.attachments.length > 0 && (
                    <div className="announcement-attachments-preview">
                      <FaPaperclip /> {announcement.attachments.length}{" "}
